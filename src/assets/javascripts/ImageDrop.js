const downscaleImage = require('./ImageCompress')
...
export class ImageDrop {
	 ...
	 */
	async insert(dataUrl) {
		const index = (this.quill.getSelection() || {}).index || this.quill.getLength();
		const downscaledUrl = await downscaleImage(dataUrl, 2000, 2000, 'jpeg')
		this.quill.insertEmbed(index, 'image', downscaledUrl, 'user');
	}
